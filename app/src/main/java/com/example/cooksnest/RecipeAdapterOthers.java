...
public class RecipeAdapterOthers extends ArrayAdapter<Recipe> {
    int resource;
    Context cntx;
    List<Recipe> data;
    ...
    public RecipeAdapterOthers(Context ctx, int res, List<Recipe> tasks) {
        super(ctx, res, tasks);
        cntx = ctx;
        data = tasks;
        resource = res;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView NameView = (TextView) itemView.findViewById(R.id.OtherRecipeName);

        NameView.setText(it.getRecipeName());

        TextView ServesView = (TextView) itemView.findViewById(R.id.otherservingSize);

        String servings = String.valueOf(it.getServings());
        ServesView.setText("Serves " +  servings + " people");

        TextView HoursView = (TextView) itemView.findViewById(R.id.otherprepTime);
        ImageView food = itemView.findViewById(R.id.otherfoodpic);
        if (it.getImagepath() != null) {
            ...
            ImageButton viewdetails = itemView.findViewById(R.id.otheropendetails);
